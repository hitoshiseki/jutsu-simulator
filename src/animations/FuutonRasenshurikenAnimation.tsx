...
export interface FuutonRasenshurikenAnimationRef {
    cleanup: () => void;
}
...
export const FuutonRasenshurikenAnimation = React.forwardRef<FuutonRasenshurikenAnimationRef, Props>(
    function FuutonRasenshurikenAnimation ({ onPowerStart, onPowerReset, lang = 'en' }, ref) {
        ...
        }, [animScale, animOpacity, playSound, stopVibrationLoop, stopSpinLoop]);
        ...
        }, [animScale, animOpacity, playSound, startSpinLoop, stopSpinLoop]);
...
const styles = StyleSheet.create({
    ...
    ripple: {
        ...
        height: 52,
        borderRadius: 26,
        backgroundColor: 'rgba(187,68,255,0.25)',
        top: 2,
    },
    handIcon: {
        fontSize: 38,
